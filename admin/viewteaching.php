                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 right ps-2 overflow-y-scroll" style="height:595px;">
                            ...
                            <div class="text-center">
                                    <span class="fs-4 ms-5 text-center text-light pb-2" style="font-family: 'Times New Roman', Times, serif;border-bottom: 2px solid;">All Teaching Staff</span>
                                </div>
                                <table class="table mt-5 table-striped-columns">
                                    ...
                                    <tr align="center" >
                                            ...
                                            <td><?php echo $a; ?></td>
                                            <td><img src="http://localhost/RNC/admin/teacher/<?php echo $row['photo'];?>" height="100px"/></td>
                                            ...
                                            <td><a href="editteacher.php?id=<?php echo $row['tid']; ?>" class="btn text-success"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td><a href="delteacher.php?id=<?php echo $row['tid']; ?>" class="btn btn-danger">delete</a></td>
                                    </tr>
                                    <?php
                                        $a++;
                                        }
