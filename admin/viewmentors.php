                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 right ps-2 overflow-y-scroll" style="height:595px;">
                            ...
                            <div class="text-center">
                                    <span class="fs-4 ms-5 text-center text-light pb-2" style="font-family: 'Times New Roman', Times, serif;border-bottom: 2px solid;">Mentors on front page</span>
                                </div>
                                ...
                                <table class="table mt-5 table-striped-columns">
                                    <tr align="center">
                                        ...
                                        <th><span class="fs-5 fw-semibold">Place</span></th>
                                        <th><span class="fs-5 fw-semibold">Dom</span></th>
                                    ...
                                    <tr align="center">
                                            ...
                                            <td><a href="deletementor.php?id=<?php echo $row['mid']; ?>"class="btn btn-danger" >delete</a></td>
                                    </tr>
                                    <?php
                                        $a++;
                                        }
